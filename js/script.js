...
loader.load( './sweet-seventeen/models/cake_3d/scene.gltf', function ( data ) {
...
const loadHeart = () => {
    loader.load( './sweet-seventeen/models/low_poly_spinning_heart/scene.gltf', function ( data ) {
